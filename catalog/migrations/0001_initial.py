# Generated by Django 4.0.1 on 2022-01-15 14:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Descrição', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Genero, exemplo: Comedia...', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Language',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Linguagem, exemplo: Portugues...', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstace',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Identificador', primary_key=True, serialize=False)),
